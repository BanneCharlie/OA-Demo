...
import com.banne.template.api.DevConfigApi;
import com.banne.template.api.FileBucketAuthEnum;
...
public class FileLocalUtil {
    ...
    private static void initClient() {
        ...
        if(SystemUtil.getOsInfo().isWindows()) {
            ...
            localFolderForWindows = "G:\\Test\\file";
            if(ObjectUtil.isEmpty(localFolderForWindows)) {
                throw new BusinessException(ResultCodeEnum.UPLOAD_PATH_ERROR);
            }
            uploadFileFolder = localFolderForWindows;
        }else{
            uploadFileFolder = "G:\\Test\\file";
        }
     ...
     * @date 2022/1/5 23:24
     */
    public static void setBucketAcl(String bucketName, FileBucketAuthEnum devFileBucketAuthEnum) {
        // 无需
    }
    ...
    public static void storageFile(String bucketName, String key, File file) {
        ...
        try {
            ...
            throw new BusinessException(ResultCodeEnum.FILE_STREAM_ERROR);
        }
     ...
     * @date 2022/1/5 23:24
     */
    public static void setFileAcl(String bucketName, String key, FileBucketAuthEnum devFileBucketAuthEnum) {
        // 无需
    }
